...
const Tobbar = () => {
  return (
    <Box sx={{position:"static",width:"100%",display:"flex",flexDirection:"row",justifyContent:"space-between",justifyItems:"center",alignItems:"center",backgroundColor:"#0071a7",height:"20px"}}>
       <Row>
