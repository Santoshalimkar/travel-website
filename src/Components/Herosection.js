  ...
  return (
    <>
        <Image
            ...
            src={Heroimg}
            objectFit='cover'
            css={{filter:"brightness(70%)",position:"absolute",backgroundSize:"cover"}}
        />
      ...
      />
        ...
        <Button sx={{position:"relative",marginLeft:"540px",marginTop:"-25px",borderRadius:"30px",backgroundColor:"#0071a7"}} variant='contained'><FilterAltIcon/>MORE FILTERS</Button>
